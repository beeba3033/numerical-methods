...
export default class GaussEliminationMethod extends LinearAlgebra{
    constructor(props:PropsMethod) {
        ...
        this.props.StateNumerical.Matrix.Data.MatrixA = this.props.StateNumerical.Method.LinearAlgebra.GaussElimination.MatrixA;
        this.props.StateNumerical.Matrix.Data.MatrixB = this.props.StateNumerical.Method.LinearAlgebra.GaussElimination.MatrixB;
    ...
    solve(matrixA:Array<Array<number>>,matrixB:Array<Array<number>>){
    ...
    handleSubmit(event:FormEvent<HTMLFormElement>){
        ...
        this.props.StateNumerical.Method.LinearAlgebra.GaussElimination.MatrixA = this.props.StateNumerical.Matrix.Data.MatrixA;
        this.props.StateNumerical.Method.LinearAlgebra.GaussElimination.MatrixB = this.props.StateNumerical.Matrix.Data.MatrixB;

        //call function for calculate this method
        let Result:any = this.solve(
            this.props.StateNumerical.Method.LinearAlgebra.GaussElimination.MatrixA,
            this.props.StateNumerical.Method.LinearAlgebra.GaussElimination.MatrixB,
        );
    ...
    async componentDidMount() {
        ...
        await axios.post(this.props.Login.pathLogin, {
            ...
            .then(async res => {
                await axios.get(api, { headers: {"Authorization" : `Bearer ${res.data.accessToken.replace(regex,'')}`} })
                    .then(async res => {
                        this.props.StateNumerical.Problem = await res.data.Chapter[6].GaussElimination;
        ...
        //         this.props.StateNumerical.Problem = res.data.Chapter[6].GaussElimination;
        //         this.setState({StateNumerical:this.props.StateNumerical})
        //     });
        // await fetch(
        //     this.Url)
        ...
        //     .then(async (json) => {
        //         console.log(json);
        //         this.props.StateNumerical.Problem = json.Chapter[6].GaussElimination;
        //         this.setState({StateNumerical:this.props.StateNumerical});
        //     })
